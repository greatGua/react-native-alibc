...
@ReactModule(name = RNAlibcWebviewModule.REACT_CLASS)
public class RNAlibcWebviewModule extends ReactContextBaseJavaModule implements ActivityEventListener {
    ...
    public RNAlibcWebviewModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void startPhotoPickerIntent(ValueCallback<Uri> filePathCallback, String acceptType) {
        ...
        if (chooserIntent.resolveActivity(getCurrentActivity().getPackageManager()) != null) {
            ...
            Log.w("RNAlibcWebviewModule", "there is no Activity to handle this Intent");
        }
    }
